  ...
  return (
    ...
    peer-focus:text-sm peer-focus:text-terBg peer-focus:-top-3 resize-none"
      ...
      <motion.button
        ...
        type="submit"
        className="text-gray-200 hover:bg-black hover:bg-opacity-30 hover:text-terBg transition-colors duration-300 text-xs sm:text-sm w-24 sm:w-28 inline-block self-end p-1 md:p-2 border-2 border-terBg  rounded-lg"
      >
        Send Message
      </motion.button>
    </form>
